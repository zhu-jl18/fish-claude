...
Contains reusable rule fragments for project docs, baseline CLI config references, MCP setup guides, skills, and output styles for Claude Code, Codex, Gemini CLI, etc.
...
6. **If file structure changes**, update index docs (`agent-instructions/README.md`, `system-prompts/README.md`, `mcp/README.md`).
