...
工具文件：`tools/codex-provider-history-migrator/migrate_codex_provider_history.py`
...
```bash
python tools/codex-provider-history-migrator/migrate_codex_provider_history.py
```
...
```bash
python tools/codex-provider-history-migrator/migrate_codex_provider_history.py --apply
```
...
```bash
python tools/codex-provider-history-migrator/migrate_codex_provider_history.py --apply --backup-dir "/mnt/d/temp/codex-provider-backup"
```

**PowerShell:**

```powershell
python tools/codex-provider-history-migrator/migrate_codex_provider_history.py --apply --backup-dir "D:/temp/codex-provider-backup"
```
...
```bash
python tools/codex-provider-history-migrator/migrate_codex_provider_history.py --codex-home "/mnt/d/portable/codex-home" --apply
```

**PowerShell:**

```powershell
python tools/codex-provider-history-migrator/migrate_codex_provider_history.py --codex-home "D:/portable/codex-home" --apply
```
...
```bash
python tools/codex-provider-history-migrator/migrate_codex_provider_history.py --keep-provider openai --keep-provider custom --keep-provider oss
```
