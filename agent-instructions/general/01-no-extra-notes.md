...
- One Example: 当用户要求你更改某项功能并同步文档时，正确做法是直接替换旧描述，像代码里的无缝替换一样干净；错误做法是保留旧描述再补一段迁移说明，或者替换完旧描述后又多加一句迁移/补充信息。
- One More Example: 比如 README 里的表格已经完整反映了新改动，正确做法是更新完就停；错误做法是只因为这次改动“看起来重要”，就在表格下额外加一行注释或废话，破坏原本的统一和美感。
